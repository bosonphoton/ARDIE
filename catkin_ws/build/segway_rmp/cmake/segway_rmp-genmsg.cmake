...
set(MSG_I_FLAGS "-Isegway_rmp:/home/chels/catkin_ws/src/segway_rmp/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/chels/catkin_ws/src/segway_rmp/msg/SegwayStatusStamped.msg" NAME_WE)
add_custom_target(_segway_rmp_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "segway_rmp" "/home/chels/catkin_ws/src/segway_rmp/msg/SegwayStatusStamped.msg" "segway_rmp/SegwayStatus:std_msgs/Header"
)

get_filename_component(_filename "/home/chels/catkin_ws/src/segway_rmp/msg/SegwayStatus.msg" NAME_WE)
add_custom_target(_segway_rmp_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "segway_rmp" "/home/chels/catkin_ws/src/segway_rmp/msg/SegwayStatus.msg" ""
)
...
_generate_msg_cpp(segway_rmp
  ...
  "${MSG_I_FLAGS}"
  "/home/chels/catkin_ws/src/segway_rmp/msg/SegwayStatus.msg;/opt/ros/melodic/share/std_msgs/cmake/../msg/Header.msg"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/segway_rmp)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/segway_rmp\")")
  # install generated code
  install(
