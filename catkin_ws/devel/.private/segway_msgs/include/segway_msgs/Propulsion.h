...
struct Propulsion_
{
  ...
  _min_propulsion_battery_soc_type min_propulsion_battery_soc;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _mcu_battery_soc_type;
  _mcu_battery_soc_type mcu_battery_soc;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _mcu_battery_temp_degC_type;
  _mcu_battery_temp_degC_type mcu_battery_temp_degC;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _mcu_inst_power_W_type;
  _mcu_inst_power_W_type mcu_inst_power_W;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _mcu_total_energy_Wh_type;
  _mcu_total_energy_Wh_type mcu_total_energy_Wh;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _motor_current_A0pk_type;
  ...
  _max_motor_current_A0pk_type max_motor_current_A0pk;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _motor_current_limit_A0pk_type;
...
bool operator==(const ::segway_msgs::Propulsion_<ContainerAllocator1> & lhs, const ::segway_msgs::Propulsion_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.min_propulsion_battery_soc == rhs.min_propulsion_battery_soc &&
    lhs.mcu_battery_soc == rhs.mcu_battery_soc &&
    lhs.mcu_battery_temp_degC == rhs.mcu_battery_temp_degC &&
    lhs.mcu_inst_power_W == rhs.mcu_inst_power_W &&
    lhs.mcu_total_energy_Wh == rhs.mcu_total_energy_Wh &&
    lhs.motor_current_A0pk == rhs.motor_current_A0pk &&
    lhs.max_motor_current_A0pk == rhs.max_motor_current_A0pk &&
    lhs.motor_current_limit_A0pk == rhs.motor_current_limit_A0pk &&
    lhs.min_motor_current_limit_A0pk == rhs.min_motor_current_limit_A0pk;
}
