...
struct AuxPower_
{
  ...
  _header_type header;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _aux_soc_type;
  _aux_soc_type aux_soc;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _aux_voltage_V_type;
  _aux_voltage_V_type aux_voltage_V;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _aux_current_A_type;
  _aux_current_A_type aux_current_A;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _aux_temp_degC_type;
  _aux_temp_degC_type aux_temp_degC;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _aux_sys_status_type;
  _aux_sys_status_type aux_sys_status;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _aux_bcu_status_type;
  _aux_bcu_status_type aux_bcu_status;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _aux_bcu_faults_type;
...
bool operator==(const ::segway_msgs::AuxPower_<ContainerAllocator1> & lhs, const ::segway_msgs::AuxPower_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.aux_soc == rhs.aux_soc &&
    lhs.aux_voltage_V == rhs.aux_voltage_V &&
    lhs.aux_current_A == rhs.aux_current_A &&
    lhs.aux_temp_degC == rhs.aux_temp_degC &&
    lhs.aux_sys_status == rhs.aux_sys_status &&
    lhs.aux_bcu_status == rhs.aux_bcu_status &&
    lhs.aux_bcu_faults == rhs.aux_bcu_faults &&
    lhs.startup_7p2v_batt_voltage_V == rhs.startup_7p2v_batt_voltage_V;
}
