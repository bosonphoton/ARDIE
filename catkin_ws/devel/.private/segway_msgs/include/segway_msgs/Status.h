...
struct Status_
{
  ...
  _fault_status_words_type fault_status_words;
   ...
   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _mcu_fault_status_type;
...
bool operator==(const ::segway_msgs::Status_<ContainerAllocator1> & lhs, const ::segway_msgs::Status_<ContainerAllocator2> & rhs)
{
