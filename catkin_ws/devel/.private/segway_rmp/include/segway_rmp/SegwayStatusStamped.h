...
bool operator==(const ::segway_rmp::SegwayStatusStamped_<ContainerAllocator1> & lhs, const ::segway_rmp::SegwayStatusStamped_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.segway == rhs.segway;
}
