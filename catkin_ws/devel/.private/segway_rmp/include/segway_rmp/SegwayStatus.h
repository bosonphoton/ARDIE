...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef LIGHT
#endif
#if defined(_WIN32) && defined(TALL)
  #undef TALL
#endif
#if defined(_WIN32) && defined(HEAVY)
  #undef HEAVY
#endif
#if defined(_WIN32) && defined(BALANCE)
  #undef BALANCE
#endif
#if defined(_WIN32) && defined(TRACTOR)
  #undef TRACTOR
#endif
#if defined(_WIN32) && defined(POWER_DOWN)
  #undef POWER_DOWN
#endif
...
bool operator==(const ::segway_rmp::SegwayStatus_<ContainerAllocator1> & lhs, const ::segway_rmp::SegwayStatus_<ContainerAllocator2> & rhs)
{
  return lhs.pitch_angle == rhs.pitch_angle &&
    ...
    lhs.left_wheel_velocity == rhs.left_wheel_velocity &&
    lhs.right_wheel_velocity == rhs.right_wheel_velocity &&
    lhs.yaw_rate == rhs.yaw_rate &&
    lhs.servo_frames == rhs.servo_frames &&
    lhs.left_wheel_displacement == rhs.left_wheel_displacement &&
    lhs.right_wheel_displacement == rhs.right_wheel_displacement &&
    lhs.forward_displacement == rhs.forward_displacement &&
    lhs.yaw_displacement == rhs.yaw_displacement &&
    lhs.left_motor_torque == rhs.left_motor_torque &&
    lhs.right_motor_torque == rhs.right_motor_torque &&
    lhs.operation_mode == rhs.operation_mode &&
    lhs.gain_schedule == rhs.gain_schedule &&
    lhs.ui_battery == rhs.ui_battery &&
    lhs.powerbase_battery == rhs.powerbase_battery &&
    lhs.motors_enabled == rhs.motors_enabled;
}
