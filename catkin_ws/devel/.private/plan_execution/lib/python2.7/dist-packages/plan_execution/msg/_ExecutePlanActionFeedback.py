...
class ExecutePlanActionFeedback(genpy.Message):
  _md5sum = "ec805fbae40be3e6371fdd2ca255ac1f"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.event_type
      buff.write(_get_struct_i().pack(_x))
      length = len(self.feedback.plan)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.plan:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.event_type,) = _get_struct_i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.feedback.plan = []
      for i in range(0, length):
        ...
        self.feedback.plan.append(val1)
      return self
