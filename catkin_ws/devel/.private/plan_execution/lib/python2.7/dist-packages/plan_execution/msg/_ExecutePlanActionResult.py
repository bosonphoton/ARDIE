...
class ExecutePlanActionResult(genpy.Message):
  _md5sum = "04555b40b848d3fa683a9052dde019c3"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.result.final_action.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.final_action.variables)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.final_action.variables:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      _x = self.result.final_action.timeStep
      buff.write(_get_struct_I().pack(_x))
      length = len(self.result.plan_remainder)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.plan_remainder:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = val1.timeStep
        buff.write(_get_struct_I().pack(_x))
      length = len(self.result.inconsistent_rules)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.inconsistent_rules:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.final_action.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.final_action.name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.final_action.variables = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.result.final_action.variables.append(val1)
      start = end
      end += 4
      (self.result.final_action.timeStep,) = _get_struct_I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.plan_remainder = []
      for i in range(0, length):
        ...
        self.result.plan_remainder.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.inconsistent_rules = []
      for i in range(0, length):
        ...
        self.result.inconsistent_rules.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
