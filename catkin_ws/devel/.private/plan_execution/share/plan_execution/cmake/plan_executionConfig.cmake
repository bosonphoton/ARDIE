...
if("TRUE" STREQUAL "TRUE")
  set(plan_execution_SOURCE_PREFIX /home/chels/catkin_ws/src/bwi_common/plan_execution)
  set(plan_execution_DEVEL_PREFIX /home/chels/catkin_ws/devel/.private/plan_execution)
  ...
  set(plan_execution_INSTALL_PREFIX /home/chels/catkin_ws/install)
...
if(NOT "/home/chels/catkin_ws/devel/.private/plan_execution/include;/home/chels/catkin_ws/src/bwi_common/plan_execution/include;/home/chels/catkin_ws/src/bwi_common/plan_execution/actasp/include " STREQUAL " ")
  set(plan_execution_INCLUDE_DIRS "")
  set(_include_dirs "/home/chels/catkin_ws/devel/.private/plan_execution/include;/home/chels/catkin_ws/src/bwi_common/plan_execution/include;/home/chels/catkin_ws/src/bwi_common/plan_execution/actasp/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plan_execution' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chels/catkin_ws/src/bwi_common/plan_execution/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT plan_execution_NUM_DUMMY_TARGETS)
      set(plan_execution_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::plan_execution::wrapped-linker-option${plan_execution_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR plan_execution_NUM_DUMMY_TARGETS "${plan_execution_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::plan_execution::wrapped-linker-option${plan_execution_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND plan_execution_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chels/catkin_ws/devel/.private/plan_execution/lib;/home/chels/catkin_ws/devel/lib;/opt/ros/melodic/lib)
