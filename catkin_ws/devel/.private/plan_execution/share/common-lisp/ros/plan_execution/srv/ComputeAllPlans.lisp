...
(cl:defmethod cl:initialize-instance :after ((m <ComputeAllPlans-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ComputeAllPlans-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name plan_execution-srv:<ComputeAllPlans-request> is deprecated: use plan_execution-srv:ComputeAllPlans-request instead.")))

(cl:ensure-generic-function 'goal-val :lambda-list '(m))
(cl:defmethod goal-val ((m <ComputeAllPlans-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_execution-srv:goal-val is deprecated.  Use plan_execution-srv:goal instead.")
  (goal m))

(cl:ensure-generic-function 'suboptimality-val :lambda-list '(m))
(cl:defmethod suboptimality-val ((m <ComputeAllPlans-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_execution-srv:suboptimality-val is deprecated.  Use plan_execution-srv:suboptimality instead.")
  (suboptimality m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ComputeAllPlans-request>)))
  ...
  "plan_execution/ComputeAllPlansRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ComputeAllPlans-request)))
  "Returns string type for a service object of type 'ComputeAllPlans-request"
  "plan_execution/ComputeAllPlansRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ComputeAllPlans-request>)))
  ...
  (cl:format cl:nil "AspRule[] goal~%float64 suboptimality~%~%================================================================================~%MSG: plan_execution/AspRule~%AspFluent[] head~%AspFluent[] body~%~%================================================================================~%MSG: plan_execution/AspFluent~%string name~%string[] variables~%uint32 timeStep~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ComputeAllPlans-request)))
  "Returns full string definition for message of type 'ComputeAllPlans-request"
  (cl:format cl:nil "AspRule[] goal~%float64 suboptimality~%~%================================================================================~%MSG: plan_execution/AspRule~%AspFluent[] head~%AspFluent[] body~%~%================================================================================~%MSG: plan_execution/AspFluent~%string name~%string[] variables~%uint32 timeStep~%~%~%"))
...
(cl:defclass <ComputeAllPlans-response> (roslisp-msg-protocol:ros-message)
  ((plans
    :reader plans
    :initarg :plans
    :type (cl:vector plan_execution-msg:AnswerSet)
   :initform (cl:make-array 0 :element-type 'plan_execution-msg:AnswerSet :initial-element (cl:make-instance 'plan_execution-msg:AnswerSet))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ComputeAllPlans-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ComputeAllPlans-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name plan_execution-srv:<ComputeAllPlans-response> is deprecated: use plan_execution-srv:ComputeAllPlans-response instead.")))

(cl:ensure-generic-function 'plans-val :lambda-list '(m))
(cl:defmethod plans-val ((m <ComputeAllPlans-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_execution-srv:plans-val is deprecated.  Use plan_execution-srv:plans instead.")
  (plans m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ComputeAllPlans-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'plans)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'plan_execution-msg:AnswerSet))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ComputeAllPlans-response>)))
  ...
  "plan_execution/ComputeAllPlansResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ComputeAllPlans-response)))
  "Returns string type for a service object of type 'ComputeAllPlans-response"
  "plan_execution/ComputeAllPlansResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ComputeAllPlans-response>)))
  ...
  (cl:format cl:nil "AnswerSet[] plans~%~%================================================================================~%MSG: plan_execution/AnswerSet~%AspFluent[] fluents~%bool satisfied~%~%================================================================================~%MSG: plan_execution/AspFluent~%string name~%string[] variables~%uint32 timeStep~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ComputeAllPlans-response)))
  "Returns full string definition for message of type 'ComputeAllPlans-response"
  (cl:format cl:nil "AnswerSet[] plans~%~%================================================================================~%MSG: plan_execution/AnswerSet~%AspFluent[] fluents~%bool satisfied~%~%================================================================================~%MSG: plan_execution/AspFluent~%string name~%string[] variables~%uint32 timeStep~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ComputeAllPlans)))
  ...
  "plan_execution/ComputeAllPlans")