...
(cl:defclass <IsPlanValid-request> (roslisp-msg-protocol:ros-message)
  ((plan
    :reader plan
    :initarg :plan
    :type plan_execution-msg:AnswerSet
    :initform (cl:make-instance 'plan_execution-msg:AnswerSet))
   (goal
    :reader goal
    :initarg :goal
...
(cl:defmethod cl:initialize-instance :after ((m <IsPlanValid-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IsPlanValid-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name plan_execution-srv:<IsPlanValid-request> is deprecated: use plan_execution-srv:IsPlanValid-request instead.")))

(cl:ensure-generic-function 'plan-val :lambda-list '(m))
(cl:defmethod plan-val ((m <IsPlanValid-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_execution-srv:plan-val is deprecated.  Use plan_execution-srv:plan instead.")
  (plan m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<IsPlanValid-request>)))
  ...
  "plan_execution/IsPlanValidRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'IsPlanValid-request)))
  "Returns string type for a service object of type 'IsPlanValid-request"
  "plan_execution/IsPlanValidRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<IsPlanValid-request>)))
  ...
  (cl:format cl:nil "AnswerSet plan~%AspRule[] goal~%~%================================================================================~%MSG: plan_execution/AnswerSet~%AspFluent[] fluents~%bool satisfied~%~%================================================================================~%MSG: plan_execution/AspFluent~%string name~%string[] variables~%uint32 timeStep~%~%================================================================================~%MSG: plan_execution/AspRule~%AspFluent[] head~%AspFluent[] body~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'IsPlanValid-request)))
  "Returns full string definition for message of type 'IsPlanValid-request"
  (cl:format cl:nil "AnswerSet plan~%AspRule[] goal~%~%================================================================================~%MSG: plan_execution/AnswerSet~%AspFluent[] fluents~%bool satisfied~%~%================================================================================~%MSG: plan_execution/AspFluent~%string name~%string[] variables~%uint32 timeStep~%~%================================================================================~%MSG: plan_execution/AspRule~%AspFluent[] head~%AspFluent[] body~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <IsPlanValid-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IsPlanValid-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name plan_execution-srv:<IsPlanValid-response> is deprecated: use plan_execution-srv:IsPlanValid-response instead.")))

(cl:ensure-generic-function 'valid-val :lambda-list '(m))
(cl:defmethod valid-val ((m <IsPlanValid-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_execution-srv:valid-val is deprecated.  Use plan_execution-srv:valid instead.")
  (valid m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<IsPlanValid-response>)))
  ...
  "plan_execution/IsPlanValidResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'IsPlanValid-response)))
  "Returns string type for a service object of type 'IsPlanValid-response"
  "plan_execution/IsPlanValidResponse")
