...
(cl:defmethod cl:initialize-instance :after ((m <AspFluent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AspFluent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name plan_execution-msg:<AspFluent> is deprecated: use plan_execution-msg:AspFluent instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <AspFluent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_execution-msg:name-val is deprecated.  Use plan_execution-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'variables-val :lambda-list '(m))
(cl:defmethod variables-val ((m <AspFluent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_execution-msg:variables-val is deprecated.  Use plan_execution-msg:variables instead.")
  (variables m))

(cl:ensure-generic-function 'timeStep-val :lambda-list '(m))
(cl:defmethod timeStep-val ((m <AspFluent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_execution-msg:timeStep-val is deprecated.  Use plan_execution-msg:timeStep instead.")
  (timeStep m))
