...
(cl:defmethod cl:initialize-instance :after ((m <AspRule>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AspRule)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name plan_execution-msg:<AspRule> is deprecated: use plan_execution-msg:AspRule instead.")))

(cl:ensure-generic-function 'head-val :lambda-list '(m))
(cl:defmethod head-val ((m <AspRule>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_execution-msg:head-val is deprecated.  Use plan_execution-msg:head instead.")
  (head m))

(cl:ensure-generic-function 'body-val :lambda-list '(m))
(cl:defmethod body-val ((m <AspRule>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_execution-msg:body-val is deprecated.  Use plan_execution-msg:body instead.")
  (body m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AspRule>)))
  ...
  (cl:format cl:nil "AspFluent[] head~%AspFluent[] body~%~%================================================================================~%MSG: plan_execution/AspFluent~%string name~%string[] variables~%uint32 timeStep~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AspRule)))
  "Returns full string definition for message of type 'AspRule"
  (cl:format cl:nil "AspFluent[] head~%AspFluent[] body~%~%================================================================================~%MSG: plan_execution/AspFluent~%string name~%string[] variables~%uint32 timeStep~%~%~%"))
