...
(cl:defmethod cl:initialize-instance :after ((m <AnswerSet>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AnswerSet)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name plan_execution-msg:<AnswerSet> is deprecated: use plan_execution-msg:AnswerSet instead.")))

(cl:ensure-generic-function 'fluents-val :lambda-list '(m))
(cl:defmethod fluents-val ((m <AnswerSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_execution-msg:fluents-val is deprecated.  Use plan_execution-msg:fluents instead.")
  (fluents m))

(cl:ensure-generic-function 'satisfied-val :lambda-list '(m))
(cl:defmethod satisfied-val ((m <AnswerSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_execution-msg:satisfied-val is deprecated.  Use plan_execution-msg:satisfied instead.")
  (satisfied m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AnswerSet>)))
  ...
  (cl:format cl:nil "AspFluent[] fluents~%bool satisfied~%~%================================================================================~%MSG: plan_execution/AspFluent~%string name~%string[] variables~%uint32 timeStep~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AnswerSet)))
  "Returns full string definition for message of type 'AnswerSet"
  (cl:format cl:nil "AspFluent[] fluents~%bool satisfied~%~%================================================================================~%MSG: plan_execution/AspFluent~%string name~%string[] variables~%uint32 timeStep~%~%~%"))
