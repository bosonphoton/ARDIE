...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bwi_logging' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chels/catkin_ws/src/bwi_common/bwi_logging/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chels/catkin_ws/devel/.private/bwi_logging/lib;/home/chels/catkin_ws/devel/lib;/opt/ros/melodic/lib)
