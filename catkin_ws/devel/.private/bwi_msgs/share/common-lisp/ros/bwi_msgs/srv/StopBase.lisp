...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<StopBase-request>)))
  ...
  (cl:format cl:nil "### Stop base controller service call~%#~%#   Since there can be multiple requesters, the current status~%#   returned in the response message may not immediately match the~%#   original request.~%#~%#   If more than one requester sets a PAUSED status, the robot base~%#   will remain motionless until they all request RUNNING again.  If~%#   any requester sets STOPPED, no further requests will be met, the~%#   status remaining permantently STOPPED.~%#~%#   The requester name should be sufficiently unique to avoid multiple~%#   requesters picking the same string.  A reasonable choice is the~%#   ROS node name.~%~%StopBaseStatus status   # new status requested~%string requester        # self-assigned requester name~%~%================================================================================~%MSG: bwi_msgs/StopBaseStatus~%### Stop base controller status.~%~%uint8 status~%~%# Constants defining the possible states:~%uint8 RUNNING = 0       # robot base running normally~%uint8 PAUSED =  1       # robot base motion paused~%uint8 STOPPED = 2       # terminal state: no more movement allowed~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'StopBase-request)))
  "Returns full string definition for message of type 'StopBase-request"
  (cl:format cl:nil "### Stop base controller service call~%#~%#   Since there can be multiple requesters, the current status~%#   returned in the response message may not immediately match the~%#   original request.~%#~%#   If more than one requester sets a PAUSED status, the robot base~%#   will remain motionless until they all request RUNNING again.  If~%#   any requester sets STOPPED, no further requests will be met, the~%#   status remaining permantently STOPPED.~%#~%#   The requester name should be sufficiently unique to avoid multiple~%#   requesters picking the same string.  A reasonable choice is the~%#   ROS node name.~%~%StopBaseStatus status   # new status requested~%string requester        # self-assigned requester name~%~%================================================================================~%MSG: bwi_msgs/StopBaseStatus~%### Stop base controller status.~%~%uint8 status~%~%# Constants defining the possible states:~%uint8 RUNNING = 0       # robot base running normally~%uint8 PAUSED =  1       # robot base motion paused~%uint8 STOPPED = 2       # terminal state: no more movement allowed~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<StopBase-response>)))
  ...
  (cl:format cl:nil "StopBaseStatus status   # current status after request handled~%~%~%================================================================================~%MSG: bwi_msgs/StopBaseStatus~%### Stop base controller status.~%~%uint8 status~%~%# Constants defining the possible states:~%uint8 RUNNING = 0       # robot base running normally~%uint8 PAUSED =  1       # robot base motion paused~%uint8 STOPPED = 2       # terminal state: no more movement allowed~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'StopBase-response)))
  "Returns full string definition for message of type 'StopBase-response"
  (cl:format cl:nil "StopBaseStatus status   # current status after request handled~%~%~%================================================================================~%MSG: bwi_msgs/StopBaseStatus~%### Stop base controller status.~%~%uint8 status~%~%# Constants defining the possible states:~%uint8 RUNNING = 0       # robot base running normally~%uint8 PAUSED =  1       # robot base motion paused~%uint8 STOPPED = 2       # terminal state: no more movement allowed~%~%~%"))
