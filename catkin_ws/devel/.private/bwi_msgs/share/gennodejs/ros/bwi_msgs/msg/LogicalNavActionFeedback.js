...
let LogicalNavFeedback = require('./LogicalNavFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class LogicalNavActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new LogicalNavFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LogicalNavFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LogicalNavActionFeedback(null);
    ...
    data.feedback = LogicalNavFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LogicalNavActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = LogicalNavFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new LogicalNavFeedback()
    }
...
module.exports = LogicalNavActionFeedback;
