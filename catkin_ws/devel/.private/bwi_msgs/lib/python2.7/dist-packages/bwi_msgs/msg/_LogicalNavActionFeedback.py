...
"""autogenerated by genpy from bwi_msgs/LogicalNavActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class LogicalNavActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "bwi_msgs/LogicalNavActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','bwi_msgs/LogicalNavFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LogicalNavActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = bwi_msgs.msg.LogicalNavFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = bwi_msgs.msg.LogicalNavFeedback()
