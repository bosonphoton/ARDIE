...
if("TRUE" STREQUAL "TRUE")
  set(bwi_gazebo_entities_SOURCE_PREFIX /home/chels/catkin_ws/src/bwi_common/bwi_gazebo_entities)
  set(bwi_gazebo_entities_DEVEL_PREFIX /home/chels/catkin_ws/devel/.private/bwi_gazebo_entities)
  ...
  set(bwi_gazebo_entities_INSTALL_PREFIX /home/chels/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bwi_gazebo_entities' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chels/catkin_ws/src/bwi_common/bwi_gazebo_entities/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT bwi_gazebo_entities_NUM_DUMMY_TARGETS)
      set(bwi_gazebo_entities_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::bwi_gazebo_entities::wrapped-linker-option${bwi_gazebo_entities_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR bwi_gazebo_entities_NUM_DUMMY_TARGETS "${bwi_gazebo_entities_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::bwi_gazebo_entities::wrapped-linker-option${bwi_gazebo_entities_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND bwi_gazebo_entities_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chels/catkin_ws/devel/.private/bwi_gazebo_entities/lib;/home/chels/catkin_ws/devel/lib;/opt/ros/melodic/lib)
