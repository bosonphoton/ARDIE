...
if(NOT "/home/chels/catkin_ws/src/segbot/segbot_simulation_apps/include;/usr/include " STREQUAL " ")
  set(segbot_simulation_apps_INCLUDE_DIRS "")
  set(_include_dirs "/home/chels/catkin_ws/src/segbot/segbot_simulation_apps/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'segbot_simulation_apps' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chels/catkin_ws/src/segbot/segbot_simulation_apps/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chels/catkin_ws/devel/.private/segbot_simulation_apps/lib;/home/chels/catkin_ws/devel/lib;/opt/ros/melodic/lib)
