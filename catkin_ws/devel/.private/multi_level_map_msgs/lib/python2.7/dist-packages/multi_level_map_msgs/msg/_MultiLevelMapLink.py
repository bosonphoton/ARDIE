...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.from_point.level_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.to_point.level_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.forward_message = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.reverse_message = str[start:end].decode('utf-8', 'rosmsg')
      else:
