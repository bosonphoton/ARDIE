...
struct PlannerInterfaceResponse_
{
  ...
  _status_type status;
   ...
   typedef std::vector< ::bwi_planning_common::PlannerAtom_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::bwi_planning_common::PlannerAtom_<ContainerAllocator> >> _observations_type;
...
bool operator==(const ::bwi_planning_common::PlannerInterfaceResponse_<ContainerAllocator1> & lhs, const ::bwi_planning_common::PlannerInterfaceResponse_<ContainerAllocator2> & rhs)
{
