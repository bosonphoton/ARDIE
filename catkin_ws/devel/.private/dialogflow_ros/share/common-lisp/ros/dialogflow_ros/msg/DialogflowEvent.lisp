...
(cl:defmethod cl:initialize-instance :after ((m <DialogflowEvent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DialogflowEvent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dialogflow_ros-msg:<DialogflowEvent> is deprecated: use dialogflow_ros-msg:DialogflowEvent instead.")))

(cl:ensure-generic-function 'event_name-val :lambda-list '(m))
(cl:defmethod event_name-val ((m <DialogflowEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dialogflow_ros-msg:event_name-val is deprecated.  Use dialogflow_ros-msg:event_name instead.")
  (event_name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DialogflowEvent>)))
  ...
  "dialogflow_ros/DialogflowEvent")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DialogflowEvent)))
  "Returns string type for a message object of type 'DialogflowEvent"
  "dialogflow_ros/DialogflowEvent")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DialogflowEvent>)))
  ...
  (cl:format cl:nil "string event_name~%DialogflowParameter[] parameters~%================================================================================~%MSG: dialogflow_ros/DialogflowParameter~%string param_name~%string[] value~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DialogflowEvent)))
  "Returns full string definition for message of type 'DialogflowEvent"
  (cl:format cl:nil "string event_name~%DialogflowParameter[] parameters~%================================================================================~%MSG: dialogflow_ros/DialogflowParameter~%string param_name~%string[] value~%~%"))
