...
def talker():
    ...
    pub2 = rospy.Publisher('path_string_red_robot', String, queue_size=10)
    # pub = rospy.Publisher('pose_string_blue_robot', String, queue_size=10)
    # pub = rospy.Publisher('pose_string_green_robot', String, queue_size=10)
    # pub2 = rospy.Publisher('path_string_green_robot', String, queue_size=10)
    # pub3 = rospy.Publisher('balloon_show', String, queue_size=10)
